                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        @if($edit && $edit->status == 'pending')
                                            <form action="{{ route('pusat.transaction.approve.edit', $edit->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-success d-flex align-items-center me-2 p-2">
                                                    Terima
                                                </button>
                                            </form>
                                            <form action="{{ route('pusat.transaction.reject.edit', $edit->id) }}" method="POST" class="d-inline">
                                                @csrf
