        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4>Data Stock Cabang - {{ Auth::user()->branch->name }}</h4>
                            ...
                            <tr>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        <a href="{{ route('cabang.stock.cabang.return.form', $stock->id) }}" class="btn btn-sm btn-secondary d-flex align-items-center me-2 p-2">
                                            <i data-feather="corner-up-left" style="width:16px; height:16px;"></i>
                                            Kembalikan ke Pusat
                                        </a>
                                        <a href="{{ route('cabang.stock.cabang.distribution.form', $stock->id) }}" class="btn btn-sm btn-primary d-flex align-items-center me-2 p-2">
