...
@section('content')
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4>Kembalikan Stock ke Pusat</h4>
                        <h6>Return stock</h6>
                    </div>
                </div>
            ...
            <form action="{{ route('cabang.stock.cabang.return') }}" method="POST">
                @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-12">
                                                <div class="mb-3 add-product">
                                                    ...
                                                    <input type="text" class="form-control" value="Pusat" readonly>
                                                    <input type="hidden" name="to_branch_id" value="">
                                                </div>
                                            </div>
