...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('owner.product.create') }}" class="btn btn-added">
                            ...
                            <tr>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        <a class="me-2 edit-icon p-2" href="{{ route('owner.product.show', $product->id) }}">
                                            <i data-feather="eye" class="feather-eye"></i>
                                        </a>
                                        <a class="me-2 edit-icon p-2" href="{{ route('owner.product.edit', $product->id) }}">
                                        ...
                                        <form id="delete-form-{{ $product->id }}" action="{{ route('owner.product.destroy', $product->id) }}" method="POST" style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
