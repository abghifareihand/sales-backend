...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('owner.stock.pusat.create') }}" class="btn btn-added">
                            ...
                            <tr>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        <a class="me-2 edit-icon p-2" href="{{ route('owner.stock.pusat.edit', $stock->id) }}">
                                            <i data-feather="edit" class="feather-edit"></i>
                                        </a>
                                        <a href="{{ route('owner.stock.pusat.distribution.form', $stock->id) }}" class="btn btn-sm btn-primary d-flex align-items-center me-2 p-2">
