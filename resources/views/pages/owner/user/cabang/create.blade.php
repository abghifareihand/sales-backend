            ...
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4>Tambah Akun Cabang</h4>
                        <h6>Create new user</h6>
                    </div>
                </div>

                <div class="page-btn">
                    <a href="{{ route('owner.user.cabang.index') }}" class="btn btn-added">
                        <i data-feather="arrow-left" class="me-2"></i> Back
                    </a>
                </div>
            </div>

            <form action="{{ route('owner.user.cabang.store') }}" method="POST">
                @csrf
                <div class="card">
                            ...
                            <div class="accordion-item">
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3 add-product">
                                                <label class="form-label">Akses Login Cabang</label>
                ...
                <div class="col-lg-12">
                    <div class="btn-addproduct mb-4">
                        <a href="{{ route('owner.user.cabang.index') }}" class="btn btn-cancel me-2">Batal</a>
