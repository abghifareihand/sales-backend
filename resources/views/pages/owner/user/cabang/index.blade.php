...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('owner.user.cabang.create') }}" class="btn btn-added">
                    ...
                    <table class="table datanew">
                        <thead>
                            <tr>
                                <th>Nama</th>
                                <th>Username</th>
                                <th>Akses Login Cabang</th>
                                <th class="no-sort">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($cabang as $user)
                            <tr>
                                <td>{{ $user->name }}</td>
                                <td>{{ $user->username }}</td>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        <a class="me-2 edit-icon p-2" href="{{ route('owner.user.cabang.edit', $user->id) }}">
                                        ...
                                        <form id="delete-form-{{ $user->id }}" action="{{ route('owner.user.cabang.destroy', $user->id) }}" method="POST" style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
