        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4>Data Akun Pusat</h4>
                    <h6>Manage your user</h6>
                </div>
            </div>

            <div class="page-btn">
                <a href="{{ route('owner.user.pusat.create') }}" class="btn btn-added">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive product-list">
                    <table class="table datanew">
                        ...
                        <tbody>
                            @foreach($pusat as $user)
                            <tr>
                                <td>{{ $user->name }}</td>
                                <td>{{ $user->username }}</td>
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        <a class="me-2 edit-icon p-2" href="{{ route('owner.user.pusat.edit', $user->id) }}">
                                        ...
                                        <form id="delete-form-{{ $user->id }}" action="{{ route('owner.user.pusat.destroy', $user->id) }}" method="POST" style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
