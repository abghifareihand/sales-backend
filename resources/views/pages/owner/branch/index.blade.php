...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('owner.branch.create') }}" class="btn btn-added">
                            ...
                            <tr>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        <a class="me-2 edit-icon p-2" href="{{ route('owner.branch.show', $branch->id) }}">
                                            <i data-feather="eye" class="feather-eye"></i>
                                        </a>
                                        <a class="me-2 edit-icon p-2" href="{{ route('owner.branch.edit', $branch->id) }}">
