...
class PusatTransactionEditController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.pusat.transaction-edit.index', compact('transactions'));
    }
    ...
    public function show(Transaction $transaction)
    {
        ...
        return view('pages.pusat.transaction-edit.show', compact('transaction'));
    }
    ...
    public function approveEdit(TransactionEdit $edit)
    {
        ...
        $edit->approved_by = Auth::id(); // user pusat yang approve
        $edit->save();
